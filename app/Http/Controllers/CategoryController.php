...
class CategoryController extends Controller
{
    ...
    public function update(Request $request, Category $category)
    {
        ...
        return redirect(route('category.home', compact('category')));
    }
    ...
    {
        $category->is_deactivated = true;
        $category->save();
        return redirect()->back();
    }

    public function disactiveCategory(Category $category)
    {
        $category->is_deactivated = false;
        $category->save();
        return redirect()->back();
    }
}
